...
public class PlacesObjects {
    ...
    //WSZYSTKO PONIZEJ TYCZY SIE POJEDYNCZEGO OBIEKTU DLA JEDNEGO DANIA NP. BURGER
    //Tworzymy obiekt dla konkretnego dania i dostarczamy mu nasze obecne wspólrzedne
    ...
    public void setBurger() {
        ...
        //metoda obliczajaca jak daleko od nas sa poszczegulne lokale
